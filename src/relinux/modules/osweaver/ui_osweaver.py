...
#
# Created: Fri Sep 28 20:15:34 2012
...
class Ui_OSWeaver(object):
    def setupUi(self, OSWeaver):
        ...
        self.gridLayout.addWidget(self.threadstorun, 1, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.progress, 6, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.terminal, 8, 0, 1, 2)
        self.notroot = QtGui.QLabel(OSWeaver)
        self.notroot.setObjectName(_fromUtf8("notroot"))
        self.gridLayout.addWidget(self.notroot, 5, 0, 1, 2)
